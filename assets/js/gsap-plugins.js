...
!(function (t, e) {
  ...
  function zb(e, r, i) {
    ...
    if (!p) {
      if (("," === e.substr(-1) && (e = e.substr(0, e.length - 1)), St[e])) p = St[e];
        ...
        } else (o = (+p[0] % 360) / 360), (u = p[1] / 100), (n = 2 * (h = p[2] / 100) - (a = h <= 0.5 ? h * (u + 1) : h + u - h * u)), 3 < p.length && (p[3] *= 1), (p[0] = yb(o + 1 / 3, n, a)), (p[1] = yb(o, n, a)), (p[2] = yb(o - 1 / 3, n, a));
        ...
        return arguments.length
          ? (this._ps !== t &&
              ((this._ps = t)
                ...
                : (zt(), (this._ts = this._rts), this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && Math.abs(this._zTime) !== V && (this._tTime -= V)))),
            this)
          : this._ps;
      }),
  ...
  function Qd() {
    (function _windowExists() {
      ...
      window.document &&
      ((Ae = window), (Se = Ae.document), (Re = Se.documentElement), (Ee = Md("div") || { style: {} }), Md("div"), (lr = dr(lr)), (fr = lr + "Origin"), (Ee.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0"), (Ie = !!dr("perspective")), (Fe = Ce.core.reverting), (De = 1));
  }
  function Rd(t) {
    var e,
  ...
  function ie(t, e) {
    ...
    return s.svg && t.getAttribute("transform")
      ...
      : (u !== yr ||
          ...
          t === Re ||
          s.svg ||
          ((n = o.display), (o.display = "block"), ((r = t.parentNode) && t.offsetParent) || ((a = 1), (i = t.nextElementSibling), Re.appendChild(t)), (u = he(t)), n ? (o.display = n) : Vd(t, "display"), a && (i ? r.insertBefore(t, i) : r ? r.appendChild(t) : Re.removeChild(t))),
      ...
      return (
        ...
        L.translate &&
          (("none" === L.translate && "none" === L.scale && "none" === L.rotate) ||
            (F[lr] =
              ("none" !== L.translate ? "translate3d(" + (L.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + ("none" !== L.rotate ? "rotate(" + L.rotate + ") " : "") + ("none" !== L.scale ? "scale(" + L.scale.split(" ").join(",") + ") " : "") + ("none" !== L[lr] ? L[lr] : "")),
        ...
        m !== yr &&
          ...
          (n = M = m[5]),
          6 === m.length
            ? ((s = Math.sqrt(T * T + b * b)), (o = Math.sqrt(x * x + w * w)), (u = T || b ? ar(b, T) * ir : 0), (f = w || x ? ar(w, x) * ir + u : 0) && (o *= Math.abs(Math.cos(f * nr))), r.svg && ((i -= p - (p * T + _ * w)), (n -= _ - (p * b + _ * x))))
            : ((z = m[6]),
              (D = m[7]),
              (A = m[8]),
              (S = m[9]),
              ...
              (a = m[14]),
              (h = (g = ar(z, R)) * ir),
              g && ((O = k * (v = Math.cos(-g)) + A * (y = Math.sin(-g))), (P = M * v + S * y), (C = z * v + R * y), (A = k * -y + A * v), (S = M * -y + S * v), (R = z * -y + R * v), (E = D * -y + E * v), (k = O), (M = P), (z = C)),
              (l = (g = ar(-w, R)) * ir),
        ...
        for (c in (De || Qd(), (this.styles = this.styles || Kd(t)), (b = this.styles.props), (this.tween = i), e))
          if ("autoRound" !== c && ((o = e[c]), !pt[c] || !_b(c, e, i, n, t, a)))
            if (((l = typeof o), (f = vr[c]), "function" === l && (l = typeof (o = o.call(i, n, t, a))), "string" === l && ~o.indexOf("random(") && (o = ob(o)), f)) f(this, t, c, o, i) && (T = 1);
              ...
              if (
                (k && c in k ? ((s = "function" == typeof k[c] ? k[c].call(i, n, t, a) : k[c]), r(s) && ~s.indexOf("random(") && (s = ob(s)), Ya(s + "") || (s += j.units[c] || Ya(mr(t, c)) || ""), "=" === (s + "").charAt(1) && (s = mr(t, c))) : (s = mr(t, c)),
                (h = parseFloat(s)),
                (_ = "string" === l && "=" === o.charAt(1) && o.substr(0, 2)) && (o = o.substr(2)),
                (u = parseFloat(o)),
                c in hr &&
                  ("autoAlpha" === c && (1 === h && "hidden" === mr(t, "visibility") && u && (h = 0), b.push("visibility", 0, x.visibility), Wd(this, x, "visibility", h ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)),
      ...
      (this.wrapper = function (e) {
        return arguments.length
          ? ((b =
            ...
            refreshHeight(),
            D.set(b, C ? { overflow: "hidden", position: "fixed", height: "100%", width: "100%", top: 0, left: 0, right: 0, bottom: 0 } : { overflow: "visible", position: "relative", width: "100%", height: "auto", top: "auto", bottom: "auto", left: "auto", right: "auto" }),
            this)
          : b;
      }),
    ...
    if (z || G)
      for (r = 0; r < p; r++)
        ((h = (d = a[r]).parentNode === D) || G || (q && !P)) &&
          ...
          z && (((d._isSplit && h) || (!q && h) || (P && h) || (!P && d.parentNode.parentNode === D && !d.parentNode._isSplit)) && (B.push(d), (d._x -= _), u(d, D, j) && (d._wordEnd = !0)), "BR" === d.nodeName && ((d.nextSibling && "BR" === d.nextSibling.nodeName) || 0 === r) && z.push([])));
    for (r = 0; r < p; r++)
          ...
          if (d._isSplit) for (d._next = l = d.nextSibling, d.parentNode.appendChild(d); l && 3 === l.nodeType && " " === l.textContent; ) (d._next = l.nextSibling), d.parentNode.appendChild(l), (l = l.nextSibling);
            ...
            d.parentNode._isSplit
              ? ((d._parent = d.parentNode),
                ...
                a.splice(r--, 1),
                p--)
              : h || ((g = !d.nextSibling && u(d.parentNode, D, j)), d.parentNode._parent && d.parentNode._parent.appendChild(d), g && d.parentNode.appendChild(X.createTextNode(" ")), "span" === M && (d.style.display = "inline"), H.push(d));
          ...
          if (
            ...
            ie &&
              ...
              (n = He.core.getCache(ie)).spacer
                ? (R = n.pinState)
                : (l && ((l = J(l)) && !l.nodeType && (l = l.current || l.nativeElement), (n.spacerIsNative = !!l), l && (n.spacerState = _b(l))), (n.spacer = N = l || je.createElement("div")), N.classList.add("pin-spacer"), a && N.classList.add("pin-spacer-" + a), (n.pinState = R = _b(ie))),
    ...
    r = {
      ...
      render: function render(e, t) {
        ...
        (o = d || !t.skipX ? t.getX() : a),
          ...
          t.x < 0 && (t.x = 0),
          t.y < 0 && (t.y = 0),
          f && (!t.skipX && (s < r || r < -s) && o < p(c, "x") && (t.skipX = 1), !t.skipY && (s < l || l < -s) && n < p(c, "y") && (t.skipY = 1), t.skipX && t.skipY && (u.kill(), t.vars.onAutoKill && t.vars.onAutoKill.apply(u, t.vars.onAutoKillParams || []))),
          d ? T.scrollTo(t.skipX ? o : t.x, t.skipY ? n : t.y) : (t.skipY || (c.scrollTop = t.y), t.skipX || (c.scrollLeft = t.x)),
          !g || (1 !== e && 0 !== e) || ((n = c.scrollTop), (o = c.scrollLeft), x ? (c.style.scrollSnapType = x) : c.style.removeProperty("scroll-snap-type"), (c.scrollTop = n + 1), (c.scrollLeft = o + 1), (c.scrollTop = n), (c.scrollLeft = o)),
          (t.xPrev = t.x),
          (t.yPrev = t.y),
          h && h.update();
      },
